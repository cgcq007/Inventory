...
namespace InventoryTest {
    ...
    public partial class itemInboudsDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemInboundsDataTable : global::System.Data.TypedTableBase<ItemInboundsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemInboundsRow AddItemInboundsRow(string ItemTitle, string UPC, string TrackingNum, string Manipulator, int Qty, System.DateTime Date, bool isDelete, string ShipperId) {
...
namespace InventoryTest.itemInboudsDataSetTableAdapters {
    ...
    public partial class ItemInboundsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ItemInbounds] ([ItemTitle], [UPC], [TrackingNum], [Manipulator], [ShipperId], [Qty], [Date], [isDelete]) VALUES (@ItemTitle, @UPC, @TrackingNum, @Manipulator, @ShipperId, @Qty, @Date, @isDelete);
SELECT ItemInboundId, ItemTitle, UPC, TrackingNum, Manipulator, ShipperId, Qty, Date, isDelete FROM ItemInbounds WHERE (ItemInboundId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ItemInbounds] SET [ItemTitle] = @ItemTitle, [UPC] = @UPC, [TrackingNum] = @TrackingNum, [Manipulator] = @Manipulator, [ShipperId] = @ShipperId, [Qty] = @Qty, [Date] = @Date, [isDelete] = @isDelete WHERE (([ItemInboundId] = @Original_ItemInboundId) AND ((@IsNull_ItemTitle = 1 AND [ItemTitle] IS NULL) OR ([ItemTitle] = @Original_ItemTitle)) AND ((@IsNull_TrackingNum = 1 AND [TrackingNum] IS NULL) OR ([TrackingNum] = @Original_TrackingNum)) AND ([Qty] = @Original_Qty) AND ([Date] = @Original_Date) AND ([isDelete] = @Original_isDelete));
SELECT ItemInboundId, ItemTitle, UPC, TrackingNum, Manipulator, ShipperId, Qty, Date, isDelete FROM ItemInbounds WHERE (ItemInboundId = @ItemInboundId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ItemInboundId, ItemTitle, UPC, TrackingNum, Manipulator, ShipperId, Qty, D" +
                "ate, isDelete FROM dbo.ItemInbounds\r\nWHERE  (isDelete = \'TRUE\')";
        ...
        public virtual int Insert(string ItemTitle, string UPC, string TrackingNum, string Manipulator, string ShipperId, int Qty, System.DateTime Date, bool isDelete) {
            if ((ItemTitle == null)) {
            ...
            if ((ShipperId == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(ShipperId));
            }
        ...
        public virtual int Update(string ItemTitle, string UPC, string TrackingNum, string Manipulator, string ShipperId, int Qty, System.DateTime Date, bool isDelete, int Original_ItemInboundId, string Original_ItemTitle, string Original_TrackingNum, int Original_Qty, System.DateTime Original_Date, bool Original_isDelete, int ItemInboundId) {
            if ((ItemTitle == null)) {
            ...
            if ((ShipperId == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(ShipperId));
            }
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemTitle, string UPC, string TrackingNum, string Manipulator, string ShipperId, int Qty, System.DateTime Date, bool isDelete, int Original_ItemInboundId, string Original_ItemTitle, string Original_TrackingNum, int Original_Qty, System.DateTime Original_Date, bool Original_isDelete) {
            return this.Update(ItemTitle, UPC, TrackingNum, Manipulator, ShipperId, Qty, Date, isDelete, Original_ItemInboundId, Original_ItemTitle, Original_TrackingNum, Original_Qty, Original_Date, Original_isDelete, Original_ItemInboundId);
        }
    }
